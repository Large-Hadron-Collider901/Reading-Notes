...
3. Elements that you can use to describe both headings and paragraphs are called _______________. ______________ markup provides extra information, such as where emphasis is placed in a sentence, to indicate something you have written is a quotation (and who said it), the meaning of acronyms and so on.
...
#### Keywords, Phrases, and Definitions From Chapter 10 <br>
